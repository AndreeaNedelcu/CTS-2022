package ro.ase.cts.g1099.asgn1.stage13;
...
import ro.ase.cts.g1099.asgn1.exceptions.NullValueException;
...
public class Account implements MonthlyRate {
	...
	public Account(double value, double rate, AccountType account_Type, int daysActive) {
		if (value < 0)
			throw new InvalidLoanValueException();
		else {
			loanValue = value;
