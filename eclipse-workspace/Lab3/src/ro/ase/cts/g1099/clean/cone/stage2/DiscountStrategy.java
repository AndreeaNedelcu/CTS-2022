package ro.ase.cts.g1099.clean.cone.stage2;

//stge 1- remove statics and use enums instead
	...
	public float getFinalPrice(int productType, float productPrice, int accountAgeInYears)
	  {
	    ...
	    {
	      finalPrice = (productPrice - (ON_SALE_DISCOUNT * 
	    		  productPrice)) - accountDiscount * 
	    		  (productPrice - (ON_SALE_DISCOUNT * productPrice));
	    }
	    else if (productType == ON_FINAL_SALE_PRODUCT_TYPE)
	    {
	      finalPrice = (productPrice - (ON_FINAL_SALE_DISCOUNT * 
	    		  productPrice)) - accountDiscount *
	    		  (productPrice - (ON_FINAL_SALE_DISCOUNT * productPrice));
	    }
	    return finalPrice;
	  }
}
